...
- **Phase 7 — Code intelligence:** ZIP import, source browser, agent tools, dependency/call-site browsers, cross-file candidate flow graphs; verified runtime flows pending
